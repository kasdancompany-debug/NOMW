...
export const skyCopy = {
  ...
  wingspanNote:
    "Full-width guide uses relative scale for feeling — confirm measurements before floor lock.",
  callLabel: "Play call",
  ...
  wingDemoLead: "A quiet demonstration of lift — watch the cycle, no sound required.",
